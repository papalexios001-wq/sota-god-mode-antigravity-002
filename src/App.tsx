            ...
            <div className="content-strategy-view">
              ...
              <div className="tabs-container">
                <div className="tabs" role="tablist">
                  <button
                    className={`tab-btn ${contentMode === 'bulk' ? 'active' : ''}`}
                    onClick={() => setContentMode('bulk')}
                  >
                    Bulk Content Planner
                  </button>
                  <button
                    className={`tab-btn ${contentMode === 'single' ? 'active' : ''}`}
                    onClick={() => setContentMode('single')}
                  >
                    Single Article
                  </button>
                  <button
                    className={`tab-btn ${contentMode === 'gapAnalysis' ? 'active' : ''}`}
                    onClick={() => setContentMode('gapAnalysis')}
                  >
                    Gap Analysis (God Mode)
                  </button>
                  <button
                    className={`tab-btn ${contentMode === 'refresh' ? 'active' : ''}`}
                    onClick={() => setContentMode('refresh')}
                  >
                    Quick Refresh
                  </button>
                  <button
                    className={`tab-btn ${contentMode === 'hub' ? 'active' : ''}`}
              ...
              {/* Gap Analysis Tab with God Mode */}
              {contentMode === 'gapAnalysis' && (
                <div className="tab-panel">
                  <h3 className="gradient-headline">Blue Ocean Gap Analysis</h3>

                  {/* God Mode Panel */}
                  <div
                    className="god-mode-panel"
                    style={{
                    ...
                    <div style={{
                      ...
                      <div>
                        <h3 style={{
                          ...
                          {isGodMode ? '⚡ GOD MODE ACTIVE' : '💤 God Mode (Autonomous)'}
                        </h3>
                    ...
                    {isGodMode && (
                      <>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={e => setExcludedCategories(
                        ...
                        <div style={{
                          ...
                          <h4 style={{ margin: 0, color: '#3b82f6' }}>🎯 Priority URL Queue</h4>
                          ...
                          <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
                            <input
                              ...
                              onKeyDown={e => {
                                if (e.key === 'Enter') {
                                  const input = document.getElementById('priorityUrlInput') as HTMLInputElement;
                                  const url = input.value.trim();
                                  if (url && !priorityUrls.includes(url)) {
                                    setPriorityUrls([url, ...priorityUrls]);
                                    input.value = '';
                                  }
                                }
                              }}
                          ...
                          {priorityUrls.length > 0 && (
                            <div style={{
                              ...
                              {priorityUrls.map((url, idx) => (
                                ...
                                >
                                  <span style={{ color: '#3b82f6' }}>#{idx + 1}</span>
                                  <a
                                    href={url}
                                    target="_blank"
                                  ...
                                  <button
                                    onClick={() => setPriorityUrls(priorityUrls.filter((_, i) => i !== idx))}
                                    style={{
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <div style={{ color: '#64748B', marginBottom: '0.5rem' }}>SYSTEM LOGS</div>
                            {godModeLogs.length === 0 ? (
                              <div style={{ color: '#64748B' }}>Waiting for tasks...</div>
                            ) : (
                          ...
                          <div style={{
                            ...
                            {optimizedHistory.length === 0 ? (
                              <div style={{ color: '#64748B', fontSize: '0.85rem' }}>
                                No posts optimized in this session yet.
                              </div>
                            ) : (
                  ...
                  {existingPages.length === 0 ? (
                    <div className="sitemap-warning" style={{
                      ...
                      <XIcon />
                      <div>
                        <strong>Sitemap Required:</strong> Please crawl your sitemap first.
                      </div>
                    </div>
                  ) : (
                    <button
                  ...
                  {gapSuggestions.length > 0 && (
                    <div style={{ marginTop: '2rem' }}>
                      <h4>Content Opportunities Found:</h4>
                ...
                <div className="tab-panel">
                    ...
                    <>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          placeholder="https://example.com/my-old-post"
                        />
                      </div>
                      <button
                        className="btn"
                        onClick={handleRefreshContent}
                        disabled={isGenerating || !refreshUrl}
                      >
                  ...
                  {refreshMode === 'bulk' && (
                    <>
                      ...
                      {crawlMessage && (
                        <div className="crawl-status" style={{ marginTop: '1rem' }}>
                          {crawlMessage}
                        </div>
                      )}
                        ...
                        <div className="content-hub-table-container" style={{ marginTop: '1.5rem' }}>
                          <div className="table-controls">
                            ...
                            <div className="table-actions">
                              <button
                                ...
                                onClick={handleAddToRefreshQueue}
                              ...
                              >
                                {isBulkAutoPublishing
                                  ? 'Processing...'
                                  : `Bulk Refresh & Publish (${selectedHubPages.size})`}
                              </button>
                            </div>
                          </div>
                          ...
                          {isBulkAutoPublishing && (
                            <div style={{
                              ...
                              <div>
                                Processing... {bulkAutoPublishProgress.current}/{bulkAutoPublishProgress.total}
                              </div>
                              <div style={{
                                width: '100%',
                                height: '6px',
                                ...
                                <div style={{
                                  width: `${(bulkAutoPublishProgress.current / Math.max(1, bulkAutoPublishProgress.total)) * 100}%`,
                                  height: '100%',
                                  ...
                                  <tr key={page.id}>
                                    ...
                                    <td className="hub-title-cell">
                                      <a href={page.id} target="_blank" rel="noopener noreferrer">
                                        {sanitizeTitle(page.title, page.slug)}
                                      </a>
              ...
              {contentMode === 'hub' && (
                <div className="tab-panel">
                  ...
                  <div className="sitemap-crawler-form">
                    <div className="form-group">
                      <label htmlFor="sitemapUrlHub">Sitemap URL</label>
                      <input
                        type="url"
                        id="sitemapUrlHub"
                        value={sitemapUrl}
                    ...
                    <div className="content-hub-table-container">
                      <div className="table-controls">
                        ...
                        <div className="table-actions">
                          ...
                          >
                            {isAnalyzingHealth
                              ? `Analyzing... (${healthAnalysisProgress.current}/${healthAnalysisProgress.total})`
                              : `Analyze Selected (${selectedHubPages.size})`}
                          </button>
                          <button
                            className="btn"
                            onClick={handleRewriteSelected}
                            disabled={analyzableForRewrite === 0}
                          >
                          ...
                          {isCrawling ? (
                            ...
                            filteredAndSortedHubPages.map(page => (
                              <tr key={page.id}>
                                ...
                                <td>
                                  {page.updatePriority ? (
                                    <span className={`priority-${page.updatePriority}`}>
                                      {page.updatePriority}
                                    </span>
                                  ) : (
                                    'Not Analyzed'
                                ...
                                <td>
                                  ...
                                  {page.status === 'error' && (
                                    <div className="status-cell error">
                                      <XIcon /> {page.justification?.substring(0, 20) || 'Error'}...
                                    </div>
                                  )}
              ...
              {/* Image Generator Tab */}
              {contentMode === 'imageGenerator' && FEATURE_FLAGS.ENABLE_IMAGE_GENERATION && (
                <div className="tab-panel">
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      rows={4}
                      placeholder="e.g., A photorealistic image of a golden retriever puppy playing in a field of flowers..."
                    />
                  </div>
                  ...
                  <button
                    ...
                    disabled={isGeneratingImages || !imagePrompt}
                  >
                    {isGeneratingImages ? (
                      <>
                  ...
                  {imageGenerationError && (
                    <p className="error" style={{ marginTop: '1rem' }}>{imageGenerationError}</p>
                  )}
                        ...
                        <div key={index} className="image-asset-card">
                          ...
                          <div className="image-asset-details">
                            ...
                            <button
                              ...
                              onClick={() => handleCopyText(image.prompt)}
                            >
                              Copy Prompt
                            </button>
                          </div>
